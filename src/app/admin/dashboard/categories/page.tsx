                          ...
                          <tr key={category.id} className="border-b transition-colors hover:bg-gray-50 data-[state=selected]:bg-muted">
                            ...
                            <td className="p-4 align-middle [&:has([role=checkbox])]:pr-0 text-right">
                              <div className="flex justify-end space-x-2">
                                <Link href={`/admin/dashboard/categories/${category.slug}/edit`}>
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-lg bg-gradient-to-br from-blue-50 to-indigo-100 border-0 shadow-sm">
            ...
            <div className="px-6 pb-6 space-y-4">
              ...
              <div className="pt-4">
                <Link href="/admin/dashboard/categories/create">
                  <button className="w-full inline-flex items-center justify-center rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                    <Plus className="h-4 w-4 mr-2" />
                    Add New Category
                  </button>
                </Link>
